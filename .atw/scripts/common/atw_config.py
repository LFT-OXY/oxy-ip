#!/usr/bin/env python3
"""
Standalone reader for .atw/config.yaml.

Owns the minimal YAML parser used across ATW. ``common.config`` imports
...
CONFIG_REL_PATH = ".atw/config.yaml"
...
def read_atw_config(repo_root: Optional[Path] = None) -> dict:
    """Read .atw/config.yaml. Returns {} on missing or malformed file."""
